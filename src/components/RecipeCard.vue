    ...
    <div class="recipe-card bg-white">
        ...
        <div class="bg-pink-400 text-white p-4 md:p-6 border-b-2 border-black">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <h3 class="mb-1 line-clamp-2" :class="isWechat?'text-2xl':'text-5xl'">{{ recipe.name }}</h3>
                    <div class="flex items-center gap-3" :class="isWechat?'text-xs':'text-lg'">
        ...
        <div class="p-2 md:p-6">
            <!-- 食材列表 -->
            <div class="mb-4">
                <h4 class="text-2xl font-bold text-dark-800 mb-2 flex items-center gap-1" :class="isWechat?'text-lg':'text-2xl'"><img src="/icon/树叶.png" style="width: 20px; height: 20px;"/> 所需食材</h4>
                <div class="flex flex-wrap gap-1">
                    <span v-for="ingredient in recipe.ingredients" :key="ingredient" class="bg-yellow-400 text-dark-800 px-2 py-1 rounded  font-medium border border-black" :class="isWechat?'text-xs':'text-xl'">
                        {{ ingredient }}
                    </span>
                </div>
            </div>
            ...
            <div class="mb-4">
                <div class="flex items-center justify-between mb-2">
                    <h4 class="font-bold text-dark-800 flex items-center gap-1" :class="isWechat?'text-lg':'text-2xl'">📝 制作步骤</h4>
                ...
                <div v-else class="space-y-2">
                    <div v-for="step in recipe.steps" :key="step.step" class="flex gap-3 p-3 bg-gray-50 rounded border border-gray-200">
                        ...
                        <div class="flex-1">
                            <p class="text-dark-800 mb-1" :class="isWechat?'text-md':'text-2xl'">{{ step.description }}</p>
            ...
            <div v-if="recipe.tips && recipe.tips.length > 0 && isExpanded" class="mb-4">
                <h4 class="font-bold text-dark-800 mb-2 flex items-center gap-1" :class="isWechat?'text-lg':'text-2xl'">💡 烹饪技巧</h4>
                <div class="bg-yellow-100 border-l-4 border-yellow-400 p-3 rounded-r">
                    <ul class="space-y-1">
                        <li v-for="tip in recipe.tips" :key="tip" class="flex items-start gap-2 text-dark-700">
                            ...
                            <span :class="isWechat?'text-lg':'text-2xl'">{{ tip }}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div v-if="isExpanded" class="mb-4">
                <div class="flex items-center justify-between mb-3">
                    <h4 class="font-bold text-dark-800 flex items-center gap-1" :class="isWechat?'text-lg':'text-2xl'">📊 营养分析</h4>
                    <button
            ...
            <div v-if="isExpanded" class="mb-4">
                <div class="flex items-center justify-between mb-3">
                    <h4 class="font-bold text-dark-800 flex items-center gap-1" :class="isWechat?'text-lg':'text-2xl'">🍷 酒水搭配</h4>
                    <button
            ...
            <div class="gap-3 p-3 bg-gray-50 rounded border border-gray-200">
                <h2 class="mb-1 line-clamp-2 mt-4" :class="isWechat?'text-xl':'text-3xl'"> 菜谱名称： <span class="text-orange-600">{{ recipe.name }}</span> </h2>
